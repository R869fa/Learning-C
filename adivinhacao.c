...
// define = define a constant, >>NUMBER_OF_GUESSES<< = name of the constant.
int main()
{
    ...
    {
     // i = repetition control, which goes from 1 to 3, that is, the user has 3 chances to guess the secret number.
     //i++ = increment operator, which increases the value of i by 1 each time the loop is executed.
